    ...
    const lessons = [
        ...
        },
        {
        ...
        },
         {
            theme: 'Agile_Scrum',
            date: '13.05.2023',
            link_video: 'https://youtu.be/lBn1VhDua1Y',
            description: 'На учебном занятии обсудили текущую реализацию проекта, сильные и слабые стороны командной работы в целом, плюсы и минусы действующей команды, возможные действия по улучшению результативности и эффективности работы надо проектом. Рассмотрели подробно подходы к организации работы по методологиям Agile, Scrum.',
            link_presentation: null,
            img: fullstackPartFirst
        },
        {
